...
import me.amitghosh.mathquiz.adapter.LanguageAdapter;
import me.amitghosh.mathquiz.adapter.MainAdapter;
import me.amitghosh.mathquiz.database.DatabaseAccess;
import me.amitghosh.mathquiz.model.MainModel;
import me.amitghosh.mathquiz.model.SetModel;
import me.amitghosh.mathquiz.receiver.AlarmReceiver;
...
public class MainActivity extends AppCompatActivity
    ...
    private void init() {
        ...
        setOnOffSound();
        nav_language.setTitle(getString(R.string.language) + getString(R.string.single_space) + ":" + getString(R.string.single_space) + Constant.getLanguageCode(getApplicationContext()));
    ...
    public void showLanguageDialog() {
        ...
        languageAdapter = new LanguageAdapter(getApplicationContext(), Constant.getLanguageList(getApplicationContext()), s -> {
            Constant.setDefaultLanguage(MainActivity.this);
            Constant.setLanguageCode(getApplicationContext(), Constant.getLanguageCodeFromLanguage(getApplicationContext(), s));
