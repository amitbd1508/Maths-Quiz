...
import me.amitghosh.mathquiz.model.ProgressModel;
...
public class MixedScoreActivity extends BaseActivity {
    ...
    private void init() {
        ...
        tv_score.setText(Constant.getTextString(getString(R.string.score) + getString(R.string.str_space) + score));
        tv_total_count.setText(Constant.getTextString(getString(R.string.slash) + Constant.LEVEL_SIZE));
        ...
        if (progressModels.size() > 0) {
            ...
            tv_best_score.setText(Constant.getTextString(getString(R.string.best_score) + getString(R.string.str_space) + best_score));
        }
        if (best_score > score) {
            score = best_score;
        }
